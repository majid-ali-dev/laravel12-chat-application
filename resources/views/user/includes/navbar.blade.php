...
<body>
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            ...
            <a class="navbar-brand brand-logo mr-5 chat-brand" href="{{ route('user.dashboard') }}">
                <span class="chat-emoji"></span>
                Chat Application
            </a>

            <!-- Mini version for collapsed sidebar -->
            <a class="navbar-brand brand-logo-mini chat-brand-mini" href="{{ route('user.dashboard') }}">
                Chat
            </a>
        </div>
